    ...
    <div className="min-h-screen bg-gray-50">
            ...
            {STEPS.map((step, i) => {
              ...
              return (
                ...
                >
                  ...
                  <span className={`text-[11px] font-semibold leading-tight ${isActive ? 'text-violet-600' : isDone ? 'text-green-600' : 'text-gray-400'}`}>
                    {step.shortLabel}
                  </span>
                </button>
              );
      ...
      <div className="max-w-3xl mx-auto px-6 py-10">
        ...
        <div className="flex items-center gap-2 mb-8">
          ...
          <div>
            <p className="text-xs text-gray-400 font-medium">{STEPS[currentStep].description}</p>
          </div>
        </div>
        ...
        <div key={currentStep} className="animate-in fade-in slide-in-from-right-4 duration-300">
          ...
          {currentStep === 3 && <ExecutiveSummary data={result.executiveSummary} />}
          {currentStep === 4 && <MomentumSignals data={result.momentumSignals} />}
        </div>
